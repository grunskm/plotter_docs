...
void perimeter(int X, int Y, int W, int H){
  if(printAborted==false){
    ...
    moveToPointAcc(X,Y-len);
    lower_pen();
    moveToPointAcc(X,Y-100); 
    raise_pen();
    moveToPointAcc(X-len,Y);
    lower_pen();
    moveToPointAcc(X-100,Y); 
    raise_pen();

    moveToPointAcc(X,Y+H+len);
    lower_pen();
    moveToPointAcc(X,Y+H+100); 
    raise_pen();
    moveToPointAcc(X-len,Y+H);
    lower_pen();
    moveToPointAcc(X-100,Y+H); 
    raise_pen();

    moveToPointAcc(X+W,Y+H+len);
    lower_pen();
    moveToPointAcc(X+W,Y+H+100); 
    raise_pen();
    moveToPointAcc(X+W+len,Y+H);
    lower_pen();
    moveToPointAcc(X+W+100,Y+H); 
    raise_pen();

    moveToPointAcc(X+W,Y-len);
    lower_pen();
    moveToPointAcc(X+W,Y-100); 
    raise_pen();
    moveToPointAcc(X+W+len,Y);
    lower_pen();
    moveToPointAcc(X+W+100,Y); 
    raise_pen();
